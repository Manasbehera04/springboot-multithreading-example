package com.javahub.executor.api.controller;
...
import com.javahub.executor.api.service.UserService;
@RestController
public class UserController {
	...
	public ResponseEntity<User> saveUsers(@RequestParam(value = "files") MultipartFile[] files) throws Exception {
